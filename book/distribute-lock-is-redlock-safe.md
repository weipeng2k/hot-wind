...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注意**第1步**和**第3步**，无论网络中发生怎么样的延迟，只要在这两步之间，延迟一定可以被检测出来，所以延迟如果要发生的话，一定在第3步之后。也就是获取到锁后，在**第3步**之后出现了锁的过期，也就是**Martin**最早提出的，当客户端持有一个过期锁而去操作共享资源时的问题。我再次强调，所有的分布式锁实现都会有这个问题，而使用令牌去解决显得更加不切实际。
